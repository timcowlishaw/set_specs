...
spec = Gem::Specification.new do |s|
  ...
  s.homepage          = "http://github.com/timcowlishaw/set_specs/"
  ...
  namespace :rubyforge do
    ...
    namespace :release do
      ...
      task :docs => [:rdoc] do
        ...
        remote_dir = "/var/www/gforge-projects/set_specs/" # Should be the same as the rubyforge project name
        local_dir = 'rdoc'
